...
>
> — [RFC 6298 Section 5.5](https://www.rfc-editor.org/rfc/rfc6298.html#section-5)
...
>
> — [RFC 6298 Section 2.1](https://www.rfc-editor.org/rfc/rfc6298.html#section-2)
...
Token Bucket はアプリのコードに組み込む必要がありましたが、iptables は 3 行追加するだけでレート制御ができて便利でした。
ただし、L4 での制御はリクエストの内容を見ないので、API のエンドポイントごとに細かな制限をしたい場合はアプリ層で実装する必要がありそうですね。
