    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          <div style={{ width: 28, height: 28, borderRadius: 9999, background: "#111827" }} />
          <div style={{ fontSize: 30, fontWeight: 700, color: "#4b5563" }}>{SITE_NAME}</div>
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ fontSize: 26, color: "#6b7280" }}>{dateText}</div>
